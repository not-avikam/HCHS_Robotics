...
@Autonomous(name = "Red Net Sample  - Silver Knight", group = "Silver Knight")
public class SilverKnightAutoSampleRedNet extends OpMode{
    ...
    private final Pose startPose = new Pose(135, 40, Math.toRadians(180));  // Starting position
    private final Pose scorePose = new Pose(126, 17, Math.toRadians(135));
    private final Pose pickupPose1 = new Pose(108, 23, Math.toRadians(180));
    private final Pose pickUpPose2 = new Pose(107, 13, Math.toRadians(180));
    private final Pose pushPickUpPose = new Pose(83, 11, Math.toRadians(45));
    private final Pose pushPickUpControl = new Pose(95, 25);
    private final Pose pushScorePose = new Pose(122, 11, Math.toRadians(45));
    private final Pose hangPose = new Pose(85, 48, Math.toRadians(-90));
