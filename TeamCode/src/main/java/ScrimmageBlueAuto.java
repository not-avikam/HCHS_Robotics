...
@Autonomous(name = "Blue-Scrimmage", group = "Scrimmage")
public class ScrimmageBlueAuto extends OpMode{
    //hardware
    ...
    private final Pose startPose = new Pose(8, 104, Math.toRadians(0));  // Starting position
