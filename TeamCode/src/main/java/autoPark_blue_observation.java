...
@Autonomous(name = "Blue Autonomous Observation", group = "LM3")
public class autoPark_blue_observation extends OpMode{
    ...
    private final Pose startPose = new Pose(11, 57, Math.toRadians(0));
